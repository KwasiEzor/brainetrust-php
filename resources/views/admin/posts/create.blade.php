                ...
                <div class="card p-3">
                    <div class="card-body">
                        ...
                        <form action="{{ route('posts.store') }}" method="POST"
                            class="addPostForm d-flex flex-column gap-2 p-3" enctype="multipart/form-data">
                            @csrf
                            @method('POST')
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="content" id="content" cols="30" rows="10" class="form-control resize-none"
                                    placeholder="Ajouter un contenu" required></textarea>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="video_url" class="form-control" name="video_url"
                                    placeholder="ajouter un lien video">
                            </div>
